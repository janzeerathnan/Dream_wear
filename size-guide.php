    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="mb-8">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li class="text-gray-900">Size Guide</li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <h3 class="text-2xl font-bold text-gray-900 mb-6 text-center">Size Tips & Recommendations</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 mb-4">General Tips</h4>
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start space-x-2">
                            <i class="fas fa-check text-green-500 mt-1"></i>
                            <span>Jerseys typically run true to size</span>
                        </li>
                        <li class="flex items-start space-x-2">
                            <i class="fas fa-check text-green-500 mt-1"></i>
                            <span>Consider your intended use (casual vs athletic)</span>
                        </li>
                        <li class="flex items-start space-x-2">
                            <i class="fas fa-check text-green-500 mt-1"></i>
                        ...
                        <li class="flex items-start space-x-2">
                            <i class="fas fa-check text-green-500 mt-1"></i>
                            <span>Check the specific product's fit notes</span>
                        </li>
                    </ul>
                </div>
                
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 mb-4">Still Unsure?</h4>
                    <div class="space-y-4">
                        <p class="text-gray-600">
                            If you're between sizes or need help finding the perfect fit, our customer service team is here to help!
                        </p>
                        <div class="space-y-2">
                            <a href="contact.php" class="block bg-primary text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-center">
                                Contact Support
                            </a>
                            <a href="tel:+15551234567" class="block bg-gray-200 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-300 transition-colors text-center">
                                Call: +1 (555) 123-4567
                            </a>
                        </div>
                    </div>
