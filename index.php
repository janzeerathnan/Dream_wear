...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title><?php echo SITE_NAME; ?> - Premium Jersey Design & Sales</title>
...
<body class="bg-gray-50">
    ...
    <section class="relative h-96 md:h-[600px] overflow-hidden">
        <!-- Dynamic Hero Slides -->
        <div class="hero-slide active absolute inset-0 bg-cover bg-center" style="background-image: url('./assets/home_image1.webp');">
            <div class="absolute inset-0 bg-black bg-opacity-50"></div>
        </div>
        <div class="hero-slide absolute inset-0 bg-cover bg-center" style="background-image: url('./assets//image2.jpeg');">
            <div class="absolute inset-0 bg-black bg-opacity-50"></div>
        </div>
        <div class="hero-slide absolute inset-0 bg-cover bg-center" style="background-image: url('./assets//image3.jpeg');">
            <div class="absolute inset-0 bg-black bg-opacity-50"></div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
                ...
                <div class="product-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-4">
                        ...
                        <span class="text-gray-400 line-through text-sm">Rs. <?php echo number_format($product['price'], 2); ?></span>
                        <?php else: ?>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <h2 class="text-3xl font-bold text-center mb-12">Why Choose <?php echo SITE_NAME; ?>?</h2>
