            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <span class="text-3xl font-bold text-red-500">Rs. <?php echo number_format($productData['sale_price'], 2); ?></span>
                        <span class="text-xl text-gray-400 line-through">Rs. <?php echo number_format($productData['price'], 2); ?></span>
                        <?php else: ?>
                        <span class="text-3xl font-bold text-primary">Rs. <?php echo number_format($productData['price'], 2); ?></span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-lg font-bold text-primary">Rs. <?php echo number_format($relatedProduct['price'], 2); ?></span>
