...
$shipping = $subtotal >= 5000 ? 0 : 599; // Free shipping for orders over Rs. 5000
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="text-right">
                            <p class="font-semibold text-gray-900">Rs. <?php echo number_format($item['price'] * $item['quantity'], 2); ?></p>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="border-t pt-4 space-y-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold">Rs. <?php echo number_format($tax, 2); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Shipping</span>
                        <span class="font-semibold"><?php echo $shipping > 0 ? 'Rs. ' . number_format($shipping, 2) : 'Free'; ?></span>
                    </div>
                    <div class="border-t pt-2">
                        <div class="flex justify-between">
                            <span class="text-lg font-semibold">Total</span>
                            <span class="text-lg font-semibold text-primary">Rs. <?php echo number_format($total, 2); ?></span>
                        </div>
                    </div>
                </div>
            </div>
