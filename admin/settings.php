    ...
    if (!validateCSRFToken($csrf_token)) {
        ...
        switch ($action) {
                ...
                if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
                    ...
                    if (!$currentUser || !password_verify($current_password, $currentUser['password'])) {
                        ...
                        if ($user->update($_SESSION['user_id'], ['password' => $hashedPassword])) {
                            ...
                            logActivity($_SESSION['user_id'], 'change_password', 'Admin password changed');
                        } else {
            ...
            case 'update_notification_settings':
                $new_order_notifications = isset($_POST['new_order_notifications']) ? 1 : 0;
                ...
                logActivity($_SESSION['user_id'], 'update_notification_settings', 'Updated notification preferences');
                break;
        }
    }
}
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">
                        <i class="fas fa-key mr-2 text-primary"></i>Change Admin Password
                    </h3>
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <button type="submit" class="w-full bg-secondary text-white py-2 px-4 rounded-md hover:bg-red-700 transition-colors">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">
                        <i class="fas fa-database mr-2 text-primary"></i>Database Management
                    </h3>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Create a backup of your database</p>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <a href="logs.php" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition-colors">
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between">
                                <div>
                                    <label class="font-medium text-gray-900">New Order Notifications</label>
                                    <p class="text-sm text-gray-600">Receive notifications for new orders</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="new_order_notifications" value="1" 
                                           <?php echo ($currentSettings['new_order_notifications'] ?? 1) ? 'checked' : ''; ?>
                                           class="sr-only peer">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <label class="font-medium text-gray-900">Low Stock Alerts</label>
                                    <p class="text-sm text-gray-600">Get notified when products are low in stock</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="low_stock_alerts" value="1" 
                                           <?php echo ($currentSettings['low_stock_alerts'] ?? 1) ? 'checked' : ''; ?>
                                           class="sr-only peer">
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <label class="font-medium text-gray-900">System Maintenance Alerts</label>
                                    <p class="text-sm text-gray-600">Receive alerts for system maintenance</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="maintenance_alerts" value="1" 
                                           <?php echo ($currentSettings['maintenance_alerts'] ?? 1) ? 'checked' : ''; ?>
                                           class="sr-only peer">
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                </label>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-gray-200">
                            ...
                            <span class="font-medium"><?php echo $db->getAttribute(PDO::ATTR_SERVER_VERSION); ?></span>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <a href="products.php" class="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                            <i class="fas fa-tshirt text-blue-600 mr-3"></i>
                            <div>
                                <div class="font-medium text-gray-900">Manage Products</div>
                                <div class="text-sm text-gray-600">Add, edit, or remove products</div>
                            </div>
                        </a>
                        
                        <a href="orders.php" class="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                            <i class="fas fa-shopping-cart text-green-600 mr-3"></i>
                            <div>
                                <div class="font-medium text-gray-900">View Orders</div>
                                <div class="text-sm text-gray-600">Check and manage customer orders</div>
                            </div>
                        </a>
                        ...
                        <a href="users.php" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">Manage user accounts</div>
                            </div>
                        </a>
                        
                        <a href="analytics.php" class="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
                            <i class="fas fa-chart-bar text-yellow-600 mr-3"></i>
                            <div>
                                <div class="font-medium text-gray-900">View Analytics</div>
                                <div class="text-sm text-gray-600">Check business performance</div>
                            </div>
                        </a>
                    </div>
                </div>
