...
// Get new orders (orders placed in the last 24 hours)
$newOrders = [];
...
<body class="bg-gray-100">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rs. <?php 
                                $totalRevenue = 0;
                                foreach ($order->getAll() as $orderItem) {
                                    $totalRevenue += $orderItem['total_amount'];
                                }
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Rs. <?php echo number_format($order['total_amount'], 2); ?></p>
                            </div>
    ...
    <script>
        // Sales Chart - Show actual data or empty state
        ...
        // Category Chart - Show actual data or empty state
