    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="mb-8">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li class="text-gray-900">Returns & Exchanges</li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <h3 class="text-2xl font-bold text-gray-900 mb-6 text-center">Need Help with Returns?</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Send us an email with your order details and return reason.</p>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Call our customer service team for immediate assistance.</p>
