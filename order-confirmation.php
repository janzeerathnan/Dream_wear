                    ...
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">Rs. <?php echo number_format($orderData['subtotal'], 2); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Tax:</span>
                                <span class="font-medium">Rs. <?php echo number_format($orderData['tax'], 2); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Shipping:</span>
                                <span class="font-medium">Rs. <?php echo number_format($orderData['shipping_cost'], 2); ?></span>
                            </div>
                            <div class="border-t pt-2">
                                <div class="flex justify-between font-semibold">
                                    <span>Total:</span>
                                    <span class="text-primary">Rs. <?php echo number_format($orderData['total_amount'], 2); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
