        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="orders.php" class="relative text-primary font-semibold">
                    ...
                    <div class="divide-y">
                        ...
                        <div class="p-6 flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-primary font-semibold">Rs. <?php echo number_format($item['price'], 2); ?></p>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3 mb-6">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold">Rs. <?php echo number_format($total, 2); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Shipping</span>
                            <span class="font-semibold"><?php echo $total >= 5000 ? 'Free' : 'Rs. 599'; ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Tax</span>
                            <span class="font-semibold">Rs. <?php echo number_format($total * 0.08, 2); ?></span>
                        </div>
                        <div class="border-t pt-3">
                            <div class="flex justify-between">
                                <span class="text-lg font-semibold">Total</span>
                                <span class="text-lg font-semibold text-primary">
                                    Rs. <?php echo number_format($total + ($total * 0.08) + ($total >= 5000 ? 0 : 599), 2); ?>
                                </span>
                            </div>
                        </div>
                    </div>
